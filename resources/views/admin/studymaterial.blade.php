...
<body>
                    ...
                    <nav class="classy-navbar justify-content-between" id="academyNav">
                        ...
                        <div class="calling-info">
                            <div class="call-center">
                                <a href="tel:+880 1636 095 450"><i class="icon-telephone-2"></i> <span>+880 1636 095 450</span></a>
                            </div>
                        </div>
                    </nav>
                </div>
    ...
    <div class="breadcumb-area bg-img" style="background-image: url(img/bg-img/breadcumb.png);">
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="500ms">
                        <div class="popular-course-content">
                            ...
                            <!-- <p>This is the labrotary course of Structural Programming Language, you can learn how to implement the programming codes or solving the problems.</p> -->
                            <a href="#" class="btn academy-btn btn-sm">EXPLORE</a>
                        </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="600ms">
                        <div class="popular-course-content">
                            ...
                            <!-- <p>Marketing courses teach strategies for influencing customer behavior throughout the customer lifecycle. Learn fundamentals like creating a marketing strategy.</p> -->
                            <a href="#" class="btn academy-btn btn-sm">EXPLORE</a>
                        </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="700ms">
                        <div class="popular-course-content">
                            ...
                            <!-- <p>Object Oriented Java Programming,Data Structures and Beyond Specialization.You’ll learn object-oriented programming principles.</p> -->
                            <a href="#" class="btn academy-btn btn-sm">EXPLORE</a>
                        </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="900ms">
                        <div class="popular-course-content">
                            ...
                            <!-- <p>This course gives you a complete insight into the modern design of digital systems fundamentals from an eminently practical point of view.</p> -->
                            <a href="#" class="btn academy-btn btn-sm">EXPLORE</a>
                        </div>
    ...
    <div class="popular-course-details-area wow fadeInUp" data-wow-delay="300ms">
        <div class="single-top-popular-course d-flex align-items-center flex-wrap">
            <div class="popular-course-content">
                ...
                <p>UIU is a private university located in Dhaka, Bangladesh, The government of Bangladesh approved the establishment of United International University in 2003 under the Private University Act (PUA) of 1992 (now replaced by PUA 2010).</p>
                <a href="#" class="btn academy-btn btn-sm mt-15">EXPLORE</a>
            </div>
            <div class="popular-course-thumb bg-img" style="background-image: url(img/bg-img/breadcumb.png);"></div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="cta-content d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <a href="#" class="btn academy-btn">EXPLORE</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="footer-widget mb-100">
                            ...
                            <div class="single-contact d-flex mb-30">
                                ...
                                <p>4/62 SULTAN GONJ,RAYER-BAZER</p>
                            </div>
                            <div class="single-contact d-flex mb-30">
                                <i class="icon-telephone-1"></i>
                                <p>Main: +8801772392237 <br>Office: +880 1636096450</p>
                            </div>
                            <div class="single-contact d-flex">
                                <i class="icon-contract"></i>
                                <p>atik161254@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
