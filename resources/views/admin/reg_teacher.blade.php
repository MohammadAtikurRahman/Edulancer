        ...
        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth-pages">
          ...
          <div class="card col-lg-10 mx-auto">
            ...
            <div class="card-body px-5 py-5">
              ...
              <div class="container">
              <form method="post" action ="{{ url('/loginforteacher') }}">
               {{csrf_field()}}
                        <div class="form-row">
                  ...
                  <div class="form-row">
                      <div class="col-md-4 mb-2 col-lg-6">
                        ...
                        <input type="text" class="form-control" name="t_nid" id="validationTooltip01" placeholder="If Available" >
                      </div>
                      <div class="col-md-4 mb-2 col-lg-6">
                        <label for="validationTooltip02">Passport Id</label>
                        <input type="text" class="form-control" name="t_passport" id="validationTooltip02" placeholder="If Available">
