...
<head>
    ...
    <!-- Title -->
    <title>Edulancer Live Streaming </title>
                    ...
                    <div class="col-12 h-100">
                        <div class="header-content h-100 d-flex align-items-center justify-content-between">
                            <div class="academy-logo">
                                <a href="#"><img src="img/core-img/live.png" alt=""></a>
                            </div>
                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="academyNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    <!-- <li><a href="#">Live Streaming is available </a></li> -->
                                    <h1 style="color: #9400D3" >EDULANCER'S LIVE</h1>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center mx-auto wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <h3 style="background-color:#9400d3;color:white;border-color:#9400D3" >LIVE ClASS</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-course-area d-flex align-items-center mb-100">
                        ...
                        <div class="course-content">
                            <h4>Business School Live Class</h4>
                            <p>Coming Soon</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="cta-content d-flex align-items-center justify-content-between flex-wrap">
                        <h3>Do you want to BACK EDULANCER PAGE? Get in touch!</h3>
                        <a href="http://localhost:8000/edulancer" class="btn academy-btn">EXPLORE</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="footer-widget mb-100">
                            ...
                            <nav>
                                <ul class="useful-links">
                                    <li><a href="http://localhost:8000/edulancer">Home</a></li>
                                    <li><a href="http://localhost:8000/edulancer#">Services &amp; Features</a></li>
...
<style>
    ...
    * {
    ...
    #preloader {
        background: #9400D3;
        background: -webkit-linear-gradient(to right, #9400D3, #9400D3);
        background: linear-gradient(to right, #9400D3, #9400D3);
        width: 100%;
        height: 100%;
        position: fixed;
        top: 0;
    ...
    .academy-btn {
        ...
        background: #9400D3;
        background-image: -webkit-linear-gradient(left, #9400D3 0%, #9400D3 51%, #9400D3 100%);
        background-image: linear-gradient(to right, #9400D3 0%, #9400D3 51%, #9400D3 100%);
        font-weight: 600;
    }
...
<script 
src="//code.tidio.co/nw9t0w8o7ycs8hkos6z8hxbymhhzekga.js" async>
